    ...
    if (isset($recherche)) {
        if (($lieu != 0) && ($annee != 0)) {
            for ($mois = 1; $mois <= 12; $mois++) { 
                $info = $pdo->prepare("SELECT COUNT(*) AS nbAccident FROM suicides INNER JOIN ville ON lieu = id WHERE MONTH(dateEvenement) = $mois AND (lieu =$lieu) OR (YEAR(dateEvenement) = $annee)");
                $info->execute();
...
<body>
                    ...
                    <div class="menu">
                        <a href="graph_accidents.php">
                            ...
                            <a href="graph_suicide.php">
                                <div class="puce_verte"> <p style="color:#fff; margin-left: 17px; margin-top: 19px;">05</p> </div> <div class="list-item">Suicide</div>
                            </a>
                            <hr>
                ...
                <div class="fond_blanc">
                    <div class="section_centrale">
                        ...
                        <div class="formulaire">
                            <div class="centre"><a href="graph_suicides.php">graph</a> / <a href="suicide.php">recensement</a></div>
                                <div style="text-align:center; margin-top: 40px;">
                                  <h3>Graph suicides</h3>
                                    <p  style="font-weight:bold; font-size: 15px;"> veuillez consultez ici<br> les statistiques</p>
                                </div>
                            <form action="graph_suicides.php" method="GET">
    ...
    <?php include ("datas_suicides.php"); ?>
