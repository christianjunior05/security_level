    ...
    if (isset($recherche)) {
        if (($lieu != 0) && ($annee != 0)) {
            for ($mois = 1; $mois <= 12; $mois++) { 
                $info = $pdo->prepare("SELECT COUNT(*) AS nbAccident FROM negligences INNER JOIN ville ON lieu = id WHERE MONTH(dateEvenement) = $mois AND (lieu =$lieu) OR (YEAR(dateEvenement) = $annee)");
                $info->execute();
...
<body>
                ...
                <div class="sidebar_gche">
                    <div class="menu">
                        <a href="graph_accidents.php">
                            ...
                            <hr>
                            <a href="graph_meurtres.php">
                                <div class="puce_blanche"> <p style="color:#3E3F5F; margin-left: 17px; margin-top: 19px;">04</p> </div> <div class="list-item">Meutre</div>
                            </a>
                            <hr>
                            ...
                            <a href="graph_negligence.php">
                                <div class="puce_verte"> <p style="color:#fff; margin-left: 17px; margin-top: 19px;">08</p> </div> <div class="list-item">Négligence Médical</div>
                            </a>
                ...
                <div class="fond_blanc">
                    <div class="section_centrale">
                        ...
                        <div class="formulaire">
                            <div class="centre"><a href="graph_negligene.php">graph</a> / <a href="negligence.php">recensement</a> </div>
                                <div style="text-align:center; margin-top: 40px;">
                                  <h3>Graph negligence</h3>
                                    <p  style="font-weight:bold; font-size: 15px;"> veuillez consultez ici<br> les statistiques</p>
                                </div>
                            <form action="graph_incendies.php" method="GET">
    ...
    <?php include ("datas_incendies.php"); ?>
