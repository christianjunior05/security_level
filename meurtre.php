            ...
            <div class="trois">
                <div class="sidebar_gche cacher">
                    <div class="menu">
                            ...
                            <hr>
                            <a href="meurtre.php"><div class="puce_verte"><p style="color:#ffff; margin-left: 17px; margin-top: 19px;">04</p></div> <div class="list-item">Meurtre</div></a>
                            <hr>
                            <a href="suicide.php">
    ...
    <div class="section_centrale">
                        ...
                        <div class="centre"><a href="graph_meurtre.php">graph</a> / <a href="meurtre.php">recensement</a> </div>
                                ...
                                <div style="text-align:center; margin-top: 40px;">
                                  <h3>Recensement de meurtres/atteintes à l'integrité physique </h3>
                            ...
                            <form action="connect_meurtre.php" method="post">
                                ...
                                <div class="responsive">
                                    <div style="width:200px">
                                        <fieldset> 
                                            <legend>Type de meutre</legend>
                                            <select  name="typemeurtre" class="lieu">
                                                <option value=""></option>
