...
<body>
            ...
            <div class="trois">
                <div class="sidebar_gche cacher">
                    <div class="menu">
                            ...
                            <hr>
                            <a href="negligence.php"><div class="puce_verte"><p style="color:#ffffff; margin-left: 17px; margin-top: 19px;">08</p></div> <div class="list-item">Negligeance medicale</div></a>
                    </div>
                </div>
    ...
    <div class="section_centrale">
                        ...
                        <div class="formulaire">
                            ...
                            <div class="centre"><a href="graph_negligence.php">graph</a> / <a href="negligence.php">recensement</a> </div>
                                <div style="text-align:center; margin-top: 40px;">
                                  <h3>Recensement de negligeance medicale </h3>
                                    <p  style="font-weight:bold; font-size: 15px;"> Veuillez entrez vos informations s'il vous plait !</p>
                                </div>
                            <form action="connect_negligence.php" method="post">
                                    <br><br>
                                    ...
                                    <div >
                                        <fieldset> 
                                            ...
                                            <select  name="type">
                                                ...
                                                <option value="mauvaise_prescription">mauvaise prescription</option>
                                                <option value="non_assistance">non assistance</option>
                                            </select>
                                        </fieldset>
                                    </div>
