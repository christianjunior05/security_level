            ...
            <div class="trois">
                <div class="sidebar_gche cacher">
                    <div class="menu">
                            ...
                            <hr>
                            <a href="suicide.php">
                                <div class="puce_verte"><p style="color:#ffff; margin-left: 17px; margin-top: 19px;">05</p></div> <div class="list-item">Suicide</div>
                            </a>
                            <hr>
